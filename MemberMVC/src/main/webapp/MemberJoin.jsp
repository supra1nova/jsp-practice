...
<body>
	...
	<table width="500" border="1">
		<tr height="50">
			...
			<td widht="350" align="center"><input type="text" name="id" size="40" autocomplete="false">
		</tr>
		<tr height="50">
			<td widht="150" align="center"> 패스워드 </td>
			<td widht="350" align="center"><input type="password" name="pass1" size="40" autocomplete="false">
		</tr>
		<tr height="50">
