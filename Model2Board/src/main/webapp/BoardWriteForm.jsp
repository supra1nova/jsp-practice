		...
		<form action="BoardWriteProcController" method="POST">
			<table width="600" border="1" bordercolor="gray" bgcolor="beige">
				...
				<tr height="40">
					...
					<td width="450"><input type="password" name="password" id="password" size="60" autocomplete="false"></td>
				</tr>
				<tr height="40">
				...
				<tr height="40">
					<td align="center" colspan="2">
						...
						<input type="button" value="전체 게시글" onclick="location.href='BoardListController'" > 
					</td>
				</tr>
			</table>
		</form>
