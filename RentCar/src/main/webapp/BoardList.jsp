	...
	<table width="700" border="1" bgcolor="beige">
		<tr height="40">
			<td align="right" colspan="5">
				<input type="button" onclick="location.href='RentCarMain.jsp?center=BoardWriteForm.jsp'" value="글쓰기">
			</td>
		</tr>
		<tr height="40">
...
%>
		<tr bgcolor="white">
			...
			<td width="50" align="left"> <a href="RentCarMain.jsp?center=BoardInfo.jsp?num=<%= bean.getNum() %>" style="text-decoration: none; color: black; padding: 5px">
			<%
...
<div style="display: flex; justify-content: center; text-decoration: none; color: black">
	<p>
		...
		%>
					...
					<a style="text-decoration: none; color: black" href="RentCarMain.jsp?center=BoardList.jsp?pageNum=<%= startPage - gap %>"> [이전] </a>
		<%
				}
				...
				for(int i = startPage; i <= endPage; i++){
					if(i == currentPage){
		%>
					<a style="text-decoration: none; color: black; font-weight: 900" href="RentCarMain.jsp?center=BoardList.jsp?pageNum=<%= i %>">&nbsp;<%= i %>&nbsp;</a>
		<%
						continue;
					}
		%>
					<a style="text-decoration: none; color: black" href="RentCarMain.jsp?center=BoardList.jsp?pageNum=<%= i %>">&nbsp;<%= i %>&nbsp;</a>
		<%
				}
		...
		%>
					...
					<a style="text-decoration: none; color: black" href="RentCarMain.jsp?center=BoardList.jsp?pageNum=<%= startPage + gap %>">&nbsp;[다음]&nbsp;</a>
		<%
				}
			}
		%>
