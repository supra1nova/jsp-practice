...
<body>
	...
	<h1 style="text-align:center">모든 회원 보기</h1>
		...
		<table width="800" border="1">
			...
			<tr height="50">
				<td align="center" width="150"> 
					<a href="RentCarMain.jsp?center=MemberInfo.jsp?id=<%= bean.getId() %>"><%= bean.getId() %></a>
				</td>
				<td align="center" width="250"> <%= bean.getEmail() %></td>
				<td align="center" width="200"> <%= bean.getTel() %></td>
				<td align="center" width="2000"><%= bean.getHobby() %></td>
			</tr>
			<% } %>
		</table>
	</div>
