...
<%
 ...
 %>
			<td align="center" width="25%" bgcolor="grey" id="td" onClick="location.href='RentCarMain.jsp'" style="cursor: pointer">
				<span style="color: white; font-size: 20px"> 메    인 </span>
			</td>
			<td align="center" width="25%" bgcolor="grey" onClick="location.href='RentCarMain.jsp?center=CarReservation.jsp'" style="cursor: pointer">
				<span style="color: white; font-size: 20px;">예 약 하 기</span>
			</td>	
			<td align="center" width="25%" bgcolor="grey" onClick="location.href='RentCarMain.jsp?center=CarReservationView.jsp'" style="cursor: pointer">
				<span style="color: white; font-size: 20px;">예 약 확 인</span>
			</td>
			<td align="center" width="25%" bgcolor="grey" onClick="location.href='RentCarMain.jsp?center=BoardList.jsp'" style="cursor: pointer">
